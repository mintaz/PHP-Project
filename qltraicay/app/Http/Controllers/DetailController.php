...
class DetailController  extends Controller
{
    ...
    public function promotions()
    {
        ...
        // print_r($km_old);
        return view ('frontend.pages.group-product',compact('khuyenmai','spham'));
    }
    ...
    {
        $tuyendung = DB::table('tuyendung')->first();
        // print_r($tuyendung);
    ...
    public function product($url)
    {
        ...
        return view('frontend.pages.group-product',compact('sanpham','hinhsanpham','loaisanpham','nhom','binhluan'));
        // print_r($loaisanpham);
    }
