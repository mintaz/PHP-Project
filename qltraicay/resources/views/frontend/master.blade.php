...
<html lang="en">
  <head>
    ...
    <title>VLU_PHP_FRUITSTORE</title>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{!! URL('/') !!}">
                  ...
                  <p>FruitStore <strong>VLU</strong> <span>Fresh is always the best.</span></p>
                </a>
                <!-- img based logo -->
                <!-- <a href="index.html"><img src="img/logo.jpg" alt="Trái cây Vlu"></a> -->
              </div>
              <!-- / logo  -->
               <!-- cart box -->
        ...
        <div class="navbar navbar-default" role="navigation">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
              <span class="sr-only">Bật thanh điều hướng</span>
