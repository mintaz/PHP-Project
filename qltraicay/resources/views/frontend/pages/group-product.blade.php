...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img style="width: 100%; height: 300px; background: #33af4e">
      ...
      <div class="row">
        ...
        <div class="aa-product-details-content">
          ...
          <div class="col-md-5 col-sm-5 col-xs-12">
            ...
            <a href="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}" class="MagicZoom" id="sanphams" data-options="selectorTrigger: hover; transitionEffect: false;">
            <img src="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}" style="width: 250px; height: 300px;"></a> 
             @foreach ($hinhsanpham as $hinh)
                <a data-zoom-id="sanphams" href="{!! asset('resources/upload/chitietsanpham/'.$hinh->hinhsanpham_ten) !!}" data-image="{!! asset('resources/upload/chitietsanpham/'.$hinh->hinhsanpham_ten) !!}">
